    ...
    <div>
      <Dialog.Root>
              <Dialog.Trigger asChild>
                <button className="border border-gray-100 border-solid px-7 py-2 rounded-xl duration-200 hover:border-orangeBase hover:text-orangeBase">
                  Login
                </button>
              </Dialog.Trigger>
              <Dialog.Portal>
                <Dialog.Overlay className="bg-black opacity-90 data-[state=open]:animate-overlayShow fixed inset-0" />
